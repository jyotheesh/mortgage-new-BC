...
public class RequestFilter implements Filter {
    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain) {
        ...
        if (!(request.getMethod().equalsIgnoreCase("OPTIONS"))) {
            ...
            System.out.println("Pre-flightttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt");


            response.setHeader("Access-Control-Allow-Methods", "POST,GET,DELETE");
            response.setHeader("Access-Control-Max-Age", "3600");
            response.setHeader("Access-Control-expose-Headers", "Authorization, Role, content-type," +
                    "access-control-request-headers,access-control-request-method,accept,origin," +
                    "Authorization,x-requested-with");
